          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {showChatList && (
                  <div className="absolute right-0 mt-2 max-h-96 w-80 overflow-y-auto rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                    <div
                      className="py-1"
                      role="menu"
